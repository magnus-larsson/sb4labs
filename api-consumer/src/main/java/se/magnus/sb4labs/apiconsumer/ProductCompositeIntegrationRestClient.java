...
@Component
public class ProductCompositeIntegrationRestClient implements ProductRestService, RecommendationRestService, ReviewRestService {

  private static final Logger LOG = LoggerFactory.getLogger(ProductCompositeIntegrationRestClient.class);
  ...
  public ProductCompositeIntegrationRestClient(
